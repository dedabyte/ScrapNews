...
(function(R, X, u){
  ...
  function n(a, b, d){
    var c, e;
    if(a)if(C(a))for(c in a)"prototype" == c || "length" == c || "name" == c || a.hasOwnProperty && !a.hasOwnProperty(c) || b.call(d, a[c], c, a);else if(K(a) || Ba(a)){
  ...
  function Nb(a, b, d){
    for(var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e){
      var g = b[e];
      if(F(g) || C(g))for(var h = Object.keys(g), k = 0, l = h.length; k < l; k++){
        var m = h[k], s = g[m];
  ...
  function la(a, b){
    ...
    if(d == typeof b && "object" == d)if(K(a)){
      ...
      if((d = a.length) == b.length){
        for(c =
              0; c < d; c++)if(!la(a[c], b[c]))return!1;
        return!0
      }
    }else{
  ...
  function $d(a, b){
    var d, c, e = Pa.length;
    for(c = 0; c < e; ++c)if(d = Pa[c] + b, J(d = a.getAttribute(d)))return d;
    return null
  }
  ...
  function sb(a){
    for(var b =
      a[0], d = a[a.length - 1], c, e = 1; b !== d && (b = b.nextSibling); e++)if(c || a[e] !== b)c || (c = A(va.call(a, 0, e))), c.push(b);
    return c || a
  }
  ...
  function Bb(a, b, d){
    ...
    for(b = K(b) ? b : [b]; a;){
      for(var c = 0, e = b.length; c < e; c++)if(y(d = A.data(a, b[c])))return d;
      a = a.parentNode ||
    ...
    k.url = function(b, d, e){
      ...
      if(b){
        ...
        if(!c.history || h && f){
          ...
          l.href !== b && (M = b)
        }else m[d ? "replaceState" : "pushState"](e, "", b), g(), z = p;
        return k
      }
  ...
  function Ye(){
    this.$get = function(){
      function a(a, c){
        ...
        if(a in b)throw I("$cacheFactory")("iid", a);
    ...
    this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest",
      "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, d, p, z, w, aa, M, G, E){
        ...
        function Z(a, b, c, d, e, f){
          function g(a, c, d, e){
            var f, k, l, m, q, B, w;
            if(p)for(w = Array(c.length), m = 0; m < h.length; m += 3)f = h[m], w[f] = c[f];else w = c;
            m = 0;
            for(q = h.length; m <
        ...
        function O(a, b, c){
          ...
          for(f in b.$$slots)e[f] = O(a, b.$$slots[f], c);
          return d
        }
          ...
          switch(a.nodeType){
            case 1:
              ...
              for(var l, m, q, p = a.attributes, B = 0, w = p && p.length; B < w; B++){
                ...
                l = ra(k.toLowerCase());
                h[l] = k;
                if(q || !c.hasOwnProperty(l))c[l] = m, Rc(a, l) && (c[l] = !0);
                T(a, b, m, l, q);
                I(b, l, "A", d, e, G, t)
              }
              a = a.className;
              F(a) && (a = a.animVal);
              if(J(a) && "" !== a)for(; k = g.exec(a);)l = ra(k[2]), I(b, l, "C", d, e) && (c[l] = W(k[3])), a = a.substr(k.index + k[0].length);
              break;
            case Oa:
              if(11 === Ja)for(; a.parentNode && a.nextSibling &&
        ...
        function oa(a, b, d, e, f, g, h, l, m){
          function q(a, b, c, d){
            if(a){
              ...
              a.require = H.require;
              a.directiveName = oa;
              if(E === H || H.$$isolateScope)a = ba(a, {isolateScope: !0});
              h.push(a)
            }
            if(b){
              c && (b = r(b, c, d));
              b.require = H.require;
              b.directiveName = oa;
              if(E === H || H.$$isolateScope)b = ba(b, {isolateScope: !0});
              l.push(b)
            }
          }
          ...
          function w(a, c, e, f, g){
            ...
            ja = 0;
            for(S = h.length; ja < S; ja++)m = h[ja], ea(m, m.isolateScope ? q : c, O, f, m.require && p(m.directiveName, m.require, O, z), Q);
            var Ga = c;
            E && (E.template || null === E.templateUrl) && (Ga = q);
            a && a(Ga, e.childNodes, u, g);
            for(ja = l.length - 1; 0 <= ja; ja--)m = l[ja], ea(m, m.isolateScope ? q : c, O, f, m.require && p(m.directiveName, m.require, O, z), Q)
          }
          ...
          for(var G = -Number.MAX_VALUE, t = m.newScopeDirective, Z = m.controllerDirectives, E = m.newIsolateScopeDirective, Y = m.templateDirective, O = m.nonTlbTranscludeDirective, M = !1, aa = !1, x = m.hasElementTranscludeDirective, v = d.$$element = A(b), H, oa, I, N = e, P, sa = !1, R = !1, D, ja = 0, S = a.length; ja < S; ja++){
            ...
            if(!sa && (H.replace && (H.templateUrl || H.template) || H.transclude && !H.$$tlb)){
              for(D = ja + 1; sa = a[D++];)if(sa.transclude && !sa.$$tlb || sa.replace && (sa.templateUrl || sa.template)){
                R = !0;
                break
              }
              sa = !0
            ...
            if(D = H.transclude)if(M = !0, H.$$tlb || (Ua("transclusion", O, H, v), O = H), "element" == D)x = !0, G = H.priority,
            ...
            if(H.template)if(aa = !0, Ua("template", Y, H, v), Y = H, D = C(H.template) ? H.template(v, d) : H.template, D = ma(D), H.replace){
              g = H;
            ...
            if(H.templateUrl)aa = !0, Ua("template", Y, H, v), Y = H, H.replace && (g =
              H), w = Tf(a.splice(ja, a.length - ja), v, d, f, M && N, h, l, {controllerDirectives: Z, newScopeDirective: t !== H && t, newIsolateScopeDirective: E, templateDirective: Y, nonTlbTranscludeDirective: O}), S = a.length;else if(H.compile)try{
        ...
        ga.prototype = {$normalize: ra, $addClass: function(a){
          ...
          f = pa(this.$$element);
          if("a" === f && ("href" === a || "xlinkHref" === a) || "img" === f && "src" === a)this[a] = b = E(b, "src" === a);else if("img" === f && "srcset" === a){
  ...
  function Ze(){
    ...
    this.$get = ["$injector", "$window", function(d, c){
      ...
      return function(f, g, h, k){
        ...
        if(h)return h = (K(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), s && e(g, s, l, m || f.name), P(function(){
      ...
      function k(f, k, s, q){
        function z(a){
          try{
            ...
            var d;
            if(q && !y(a))d = a;else if(null == a)d = "";else{
              switch(typeof a){
                case "string":
                  break;
                case "number":
        ...
        var n, M, G = 0, E = [], Y = [];
        w = f.length;
        for(var L = [], Z = []; G < w;)if(-1 != (n = f.indexOf(a, G)) && -1 != (M = f.indexOf(b, n + l)))G !== n && L.push(g(f.substring(G, n))), G = f.substring(n + l, M), E.push(G), Y.push(d(G, z)), G = M + m, Z.push(L.length), L.push("");else{
    ...
    this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(d, c, e, f, g){
      ...
      f.on("click", function(a){
        if(b.rewriteLinks && !a.ctrlKey && !a.metaKey && !a.shiftKey &&
          ...
          for(var e = A(a.target); "a" !== pa(e[0]);)if(e[0] === f[0] || !(e = e.parent())[0])return;
        ...
        do{
          ...
          a:do{
            if(l = n.$$watchers)for(m = l.length; m--;)try{
              if(a = l[m])if((g = a.get(n)) !== (k = a.last) && !(a.eq ? la(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k)))q = !0, c = a, a.last = a.eq ? bb(g, null) : g, a.fn(g, k === r ? g : k, n), 5 > p && (M = 4 - p, B[M] || (B[M] = []), B[M].push({msg: C(a.exp) ? "fn: " + (a.exp.name ||
                a.exp.toString()) : a.exp, newVal: g, oldVal: k}));else if(a === c){
                q = !1;
                break a
              }
            }catch(y){
          ...
          if((q || w.length) && !p--)throw z.$$phase = null, d("infdig", b, B);
        }while(q || w.length);
        for(z.$$phase = null; u.length;)try{
          u.shift()()
        }catch(A){
          f(A)
        }
    ...
    this.$get = ["$injector", function(d){
      ...
      return{trustAs: function(a, b){
        ...
        if(d === ka.RESOURCE_URL){
          ...
          s = 0;
          for(q = a.length; s < q; s++)if(c(a[s], g)){
            n = !0;
            break
          }
          if(n)for(s = 0, q = b.length; s < q; s++)if(c(b[s], g)){
            n = !1;
            break
          }
          if(n)return e;
  ...
  function Ed(a, b, d, c, e){
    ...
    if(g || l)0 < e && 1 > a && (k = a.toFixed(e), a = parseFloat(k), k = k.replace(ic, c));else{
      ...
      if(h.length >= q + n)for(s = h.length - q, l = 0; l < s; l++)0 === (s - l) % n && 0 !== l && (k += d), k += h.charAt(l);
      for(l = s; l < h.length; l++)0 === (h.length - l) % q && 0 !== l && (k += d), k += h.charAt(l);
      for(; g.length < e;)g += "0";
  ...
  function Bd(a){
    ...
    return function(c, d, f){
      ...
      for(; d;)(l = ng.exec(d)) ? (h = cb(h, l, 1), d = h.pop()) : (h.push(d), d = null);
  ...
  function Lb(a, b){
    return function(d, c){
      ...
      if(J(d)){
        ...
        a.lastIndex = 0;
        if(e = a.exec(d))return e.shift(), f = c ? {yyyy: c.getFullYear(), MM: c.getMonth() + 1, dd: c.getDate(), HH: c.getHours(), mm: c.getMinutes(), ss: c.getSeconds(), sss: c.getMilliseconds() / 1E3} : {yyyy: 1970, MM: 1, dd: 1, HH: 0, mm: 0, ss: 0, sss: 0},
          n(e, function(a, c){
            c < b.length && (f[b[c]] = +a)
  ...
  n({data: Wb, inheritedData: Bb, scope: function(a){
    ...
    var c = a.nodeType;
    if(c !== Oa && 2 !== c && 8 !== c)if(c = N(b), Cb[c])if(y(d))d ? (a[b] = !0, a.setAttribute(b, c)) : (a[b] = !1, a.removeAttribute(c));else return a[b] || (a.attributes.getNamedItem(b) || v).specified ? c : u;else if(y(d))a.setAttribute(b, d);else if(a.getAttribute)return a = a.getAttribute(b, 2), null === a ? u : a
  }, prop: function(a, b, d){
  ...
  n({removeData: gb, on: function(a, b, d, c){
    ...
    D.prototype[b] = function(b, c, e){
      for(var f, g = 0, h = this.length; g < h; g++)x(f) ? (f = a(this[g], b, c, e), y(f) && (f = A(f))) : Nc(f, a(this[g], b, c, e));
      return y(f) ? f : this
    };
    ...
    host: Fb("$$host"), port: Fb("$$port"), path: kd("$$path", function(a){
      ...
      switch(arguments.length){
        case 0:
          return this.$$search;
        case 1:
          if(J(a) || U(a))a = a.toString(), this.$$search = xc(a);else if(F(a))a = bb(a, {}), n(a, function(b, c){
            null == b && delete a[c]
  ...
  fc.prototype = {constructor: fc, lex: function(a){
    ...
    for(var d = "", c = a, e = !1; this.index < this.text.length;){
      ...
      if(e)"u" === f ? (e = this.text.substring(this.index + 1, this.index + 5), e.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + e + "]"), this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += xg[f] || f, e = !1;else if("\\" === f)e = !0;else{
        if(f === a){
          this.index++;
  ...
  r.prototype = {ast: function(a){
    ...
    for(var a = this.relational(), b; b = this.expect("==", "!=", "===", "!==");)a = {type: r.BinaryExpression,
    ...
    for(var a = this.unary(), b; b = this.expect("*", "/", "%");)a = {type: r.BinaryExpression, operator: b.text,
      ...
      case r.CallExpression:
        return g = [], n(a.arguments, function(a){
          ...
          if(null != n.value){
            ...
            q = [];
            for(var r = 0; r < g.length; ++r)q.push(za(g[r](a, c, d, m), f.expression));
  ...
  var ze = ["$animate", function(a){
      ...
      this.$$setOptions = function(a){
        ...
        }else if(!m.assign)throw mb("nonassign", d.ngModel, qa(c));
      };
      this.$render = v;
      this.$isEmpty =
        function(a){
      ...
      this.$$runValidators = function(a, b, c){
        ...
        function e(){
          ...
          n(p.$asyncValidators, function(e, g){
            var h = e(a, b);
            if(!h || !C(h.then))throw mb("$asyncValidators", h);
            f(g, u);
      ...
      this.$commitViewValue = function(){
        var a = p.$viewValue;
        g.cancel(A);
        if(p.$$lastCommittedViewValue !== a || "" === a && p.$$hasNativeValidators)p.$$updateEmptyClasses(a), p.$$lastCommittedViewValue =
    ...
    Ke = ["$compile", "$parse", function(a, b){
      ...
      return{restrict: "A", terminal: !0, require: ["select", "ngModel"], link: {pre: function(a, b, c, d){
        ...
        var u = k[0], t = k[1];
        k = h.multiple;
        for(var p, z = 0, w = g.children(), v = w.length; z < v; z++)if("" === w[z].value){
          p = w.eq(z);
          break
        }
      ...
      return{restrict: "A", multiElement: !0, transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, compile: function(e, f){
        ...
        return function(a, e, f, k, l){
          ...
          a.$watchCollection(m, function(f){
            ...
            s && (a[s] = f);
            if(Ba(f))J = f, m = p || z;else for(K in m = p || w, J = [], f)ua.call(f, K) && "$" !== K.charAt(0) && J.push(K);
            C = J.length;
            K = Array(C);
            for(k = 0; k < C; k++)if(E = f === J ? k : J[k], I = f[E], F = m(E, I, k), q[F])D = q[F], delete q[F], y[F] = D, K[k] = D;else{
              if(y[F])throw n(K, function(a){
                a && a.scope && (q[a.id] = a)
              }), d("dupes", g, F, I);
            ...
            for(k = 0; k < C; k++)if(E = f === J ? k : J[k], I = f[E], D = K[k], D.scope){
              v = t;
      ...
      return{restrict: "A", require: "?ngModel", link: function(a, b, d, c){
        if(c){
          ...
          d.$observe("pattern", function(a){
            ...
            if(a && !a.test)throw I("ngPattern")("noregexp", f, a, qa(b));
            e = a || u;
            c.$validate()
          });
